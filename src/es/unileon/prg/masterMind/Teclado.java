 ...
 * 
 * Nota: esta no es una muy buena opcion de tratar los posibles errores. En
 * futuras versiones (cuendo se explique la gestion de excepciones) se mejorara
 * este tratamiento.
 *
 * @version 1.0
 * @author PRG
...
public class Teclado {
	 ...
	 * 
	 * 
	 * @return Retorna el valor introducido por el teclado. Si se introduce un
	 *         valor que no es correcto se retorna el minimo valor representable
	 *         en int (Integer.MIN_VALUE)
	 */
